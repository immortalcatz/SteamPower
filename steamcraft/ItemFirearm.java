...
public boolean shotgun;
    ...
    public ItemStack onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (var5 || par3EntityPlayer.inventory.hasItem(BoilerMod.musketCartridge.itemID))
        {
    	if (nbt.getBoolean("done") == false)
    	{
            ...
            {
                par3EntityPlayer.inventory.consumeInventoryItem(BoilerMod.musketCartridge.itemID);
            }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(BoilerMod.musketCartridge.itemID))
        {
