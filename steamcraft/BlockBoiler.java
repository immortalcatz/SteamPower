...
public class BlockBoiler extends BlockContainer
{
    ...
    {
        return BoilerMod.yourFurnaceIdle.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else if (!par5EntityPlayer.isSneaking())
        {
            ...
            if (var10 != null)
            {
            	var10.player = (Player) par5EntityPlayer;
            	var10.packetMe(par5EntityPlayer);
                par5EntityPlayer.openGui(BoilerMod.instance, 1, par1World, par2, par3, par4);
            }
