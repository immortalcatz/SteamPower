...
public class BlockForge extends Block
{
    ...
    {
        return BoilerMod.blockFurnaceExtension.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else if (!par5EntityPlayer.isSneaking())
        {
            ...
            if (var12 != null)
            {
                par5EntityPlayer.openGui(BoilerMod.instance, 0, par1World, par2 + 1, par3, par4);
            }
            else
            {
                ...
                if (var12 != null)
                {
                    par5EntityPlayer.openGui(BoilerMod.instance, 0, par1World, par2, par3 - 1, par4);
                }
                else
                {
                    ...
                    if (var12 != null)
                    {
                        par5EntityPlayer.openGui(BoilerMod.instance, 0, par1World, par2 + 1, par3 - 1, par4);
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (var12 != null)
                            {
                                par5EntityPlayer.openGui(BoilerMod.instance, 0, par1World, par2, par3, par4 + 1);
                            }
                            else
                            {
                                ...
                                if (var12 != null)
                                {
                                    par5EntityPlayer.openGui(BoilerMod.instance, 0, par1World, par2, par3 - 1, par4 + 1);
                                }
                            }
                        }
                    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (var12 != null)
        {
            if (var12.isBurning())
            {
                par1World.setBlockAndMetadataWithNotify(par2, par3, par4, BoilerMod.blockForgeOn.blockID, metadat);
            }
            else
            {
                par1World.setBlockAndMetadataWithNotify(par2, par3, par4, BoilerMod.blockForge.blockID, metadat);
            }
        }
        else
        {
