...
public class ContainerForge extends Container {
	...
	public ContainerForge(InventoryPlayer par1InventoryPlayer,
			TileEntityForge par2TileEntityForge) {
		...
		this.addSlotToContainer(new SlotForge(par1InventoryPlayer.player,
				par2TileEntityForge, 2, 116, 35));
		int var3;
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (par2 == 2) {
				...
				if (FurnaceRecipes.smelting().getSmeltingResult(var5) != null
						|| var5.itemID == SteamCraft.ingotCopper.itemID) {
