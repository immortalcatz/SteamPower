	...
	public void onUpdate() {
			...
			for (int var10 = 0; var10 < 1.0D + var24 * 60.0D; ++var10) {
				...
				if (this.rand.nextBoolean()) {
					...
					this.worldObj.spawnParticle("splash", var15,
							this.posY - 0.125D, var17, this.motionX,
		...
		if (this.worldObj.isRemote && this.field_70279_a) {
			...
			if (this.riddenByEntity != null) {
				...
				this.motionY += this.riddenByEntity.motionY;
			}
			...
			if (!this.worldObj.isRemote) {
				List var16 = this.worldObj
						.getEntitiesWithinAABBExcludingEntity(this,
								this.boundingBox.expand(0.20000000298023224D,
					...
					for (int var20 = 0; var20 < 2; ++var20) {
						...
						if (var22 == Block.snow.blockID) {
							...
							Block.waterlily.dropBlockAsItemWithChance(
									this.worldObj, var28, var21, var19, var23,
									0.3F, 0);
							this.worldObj.setBlockWithNotify(var28, var21,
									var19, 0);
						}
