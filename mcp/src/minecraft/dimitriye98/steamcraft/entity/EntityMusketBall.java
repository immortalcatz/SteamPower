package dimitriye98.steamcraft.entity;
...
public class EntityMusketBall extends Entity implements IProjectile {
	...
	public EntityMusketBall(World par1World, double par2, double par4,
			double par6) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityMusketBall(World par1World, EntityLiving par2EntityLiving,
		...
		this.setLocationAndAngles(par2EntityLiving.posX, par2EntityLiving.posY
				...
				par2EntityLiving.rotationYaw
						+ ((itemRand.nextFloat() - 0.5F) * par4 * 15F),
		...
		if (this.inGround) {
			...
			if (var4 != null) {
				if (var4.entityHit != null) {
						...
						if (var4.entityHit instanceof EntityLiving) {
							...
							if (this.shootingEntity != null) {
								EnchantmentThorns.func_92096_a(
										this.shootingEntity, var24, this.rand);
							}
					...
					// this.playSound("random.bowhit", 1.0F, 1.2F /
			...
			if (this.isInWater()) {
				for (int var25 = 0; var25 < 4; ++var25) {
					...
					this.worldObj.spawnParticle("bubble", this.posX
							- this.motionX * var26, this.posY - this.motionY
							* var26, this.posZ - this.motionZ * var26,
