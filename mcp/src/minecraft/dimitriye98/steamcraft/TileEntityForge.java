...
public class TileEntityForge extends TileEntity implements IInventory, ISidedInventory
{
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
            ...
            if ((this.furnaceItemStacks[0].isItemEqual(new ItemStack(BoilerMod.ingotCopper))) && this.furnaceItemStacks[0].stackSize > 1)
            {
                ...
                if (this.furnaceItemStacks[3].isItemEqual(new ItemStack(BoilerMod.ingotZinc)))
                {
                    var1 = new ItemStack(BoilerMod.ingotBrass);
                }
            }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            if ((this.furnaceItemStacks[0].isItemEqual(new ItemStack(BoilerMod.ingotCopper))) && this.furnaceItemStacks[0].stackSize > 1)
            {
                if (this.furnaceItemStacks[3].isItemEqual(new ItemStack(BoilerMod.ingotZinc)))
                {
                    var1 = new ItemStack(BoilerMod.ingotBrass, 2);
                }
            }
