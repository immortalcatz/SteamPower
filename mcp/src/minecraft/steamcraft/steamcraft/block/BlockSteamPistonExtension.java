...
public class BlockSteamPistonExtension extends Block
{
    ...
    public BlockSteamPistonExtension(int par1, int par2)
    {
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (var8 == SteamCraft.steamPistonBase.blockID || var8 == Block.pistonStickyBase.blockID)
        {
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (var7 != SteamCraft.steamPistonBase.blockID && var7 != Block.pistonStickyBase.blockID)
        {
            par1World.setBlockWithNotify(par2, par3, par4, 0);
        }
        else
