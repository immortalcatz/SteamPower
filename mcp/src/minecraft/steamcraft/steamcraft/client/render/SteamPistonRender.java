...
public class SteamPistonRender extends TileEntitySpecialRenderer
{
    /** instance of RenderBlocks used to draw the piston base and extension. */
    private RenderBlocks blockRenderer;

    public void renderPiston(TileEntitySteamPistonMoving par1TileEntityPiston, double par2, double par4, double par6, float par8)
    {
        ...
        if (var9 != null && par1TileEntityPiston.getProgress(par8) < 1.0F)
        {
            ...
            {
                ((BlockSteamPistonExtension) SteamCraft.steamPistonExtension).setHeadTexture(((BlockSteamPistonBase)var9).getPistonExtensionTexture());
                this.blockRenderer.renderPistonExtensionAllFaces(SteamCraft.steamPistonExtension, par1TileEntityPiston.xCoord, par1TileEntityPiston.yCoord, par1TileEntityPiston.zCoord, par1TileEntityPiston.getProgress(par8) < 0.5F);
                ((BlockSteamPistonExtension) SteamCraft.steamPistonExtension).clearHeadTexture();
    ...
    {
        this.renderPiston((TileEntitySteamPistonMoving)par1TileEntity, par2, par4, par6, par8);
    }
}
