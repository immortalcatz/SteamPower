...
public class BuildCraftCore
{
    ...
    {
        GameRegistry.addRecipe(new ItemStack(wrenchItem), "I I", " G ", " I ", 'I', Item.ingotIron, 'G', stoneGearItem);
        GameRegistry.addRecipe(new ItemStack(woodenGearItem), " S ", "S S", " S ", 'S', Item.stick);
        GameRegistry.addRecipe(new ItemStack(stoneGearItem), " I ", "IGI", " I ", 'I', Block.cobblestone, 'G',
                woodenGearItem);
        GameRegistry.addRecipe(new ItemStack(ironGearItem), " I ", "IGI", " I ", 'I', Item.ingotIron, 'G', stoneGearItem);
        GameRegistry.addRecipe(new ItemStack(goldGearItem), " I ", "IGI", " I ", 'I', Item.ingotGold, 'G', ironGearItem);
        GameRegistry.addRecipe(new ItemStack(diamondGearItem), " I ", "IGI", " I ", 'I', Item.diamond, 'G', goldGearItem);
    }
}
