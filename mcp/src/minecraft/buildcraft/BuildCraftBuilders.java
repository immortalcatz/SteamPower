...
public class BuildCraftBuilders
{
    ...
    public static void loadRecipes()
    {
        ...
        FillerManager.registry.addRecipe(new FillerFillAll(), new Object[] { "bbb", "bbb", "bbb", 'b', new ItemStack(Block.brick, 1) });
        FillerManager.registry.addRecipe(new FillerFlattener(), new Object[] { "   ", "ggg", "bbb", 'g', Block.glass,
                'b', Block.brick
                                                                             });
        FillerManager.registry.addRecipe(new FillerRemover(), new Object[] { "ggg", "ggg", "ggg", 'g', Block.glass });
        FillerManager.registry.addRecipe(new FillerFillWalls(), new Object[] { "bbb", "b b", "bbb", 'b', Block.brick });
        FillerManager.registry.addRecipe(new FillerFillPyramid(), new Object[] { "   ", " b ", "bbb", 'b', Block.brick });
        FillerManager.registry.addRecipe(new FillerFillStairs(), new Object[] { "  b", " bb", "bbb", 'b', Block.brick });
    }
