...
public class BuildCraftFactory
{
    ...
    public static void loadRecipes()
    {
        if (allowMining)
        {
            CoreProxy.proxy.addCraftingRecipe(new ItemStack(miningWellBlock, 1), new Object[] { "ipi", "igi", "iPi", 'p', Item.redstone,
                    'i', Item.ingotIron, 'g', BuildCraftCore.ironGearItem, 'P', Item.pickaxeSteel
                                                                                              });
            CoreProxy.proxy.addCraftingRecipe(
                    new ItemStack(quarryBlock),
                    new Object[] { "ipi", "gig", "dDd", 'i', BuildCraftCore.ironGearItem, 'p', Item.redstone,
                            'g', BuildCraftCore.goldGearItem, 'd', BuildCraftCore.diamondGearItem,
                            'D', Item.pickaxeDiamond,
                                 });
            CoreProxy.proxy.addCraftingRecipe(new ItemStack(pumpBlock), new Object[] { "T ", "W ", 'T', tankBlock, 'W',
                    miningWellBlock,
                                                                                     });
        }
        else
        {
            CoreProxy.proxy.addCraftingRecipe(new ItemStack(pumpBlock), new Object[] { "iri", "iTi", "gpg",
                    ...
                    'p', BuildCraftTransport.pipeLiquidsGold
                                                                                     });
        }

        CoreProxy.proxy.addCraftingRecipe(new ItemStack(autoWorkbenchBlock), new Object[] { " g ", "gwg", " g ", 'w', Block.workbench,
                'g', BuildCraftCore.woodenGearItem
                                                                                          });
        CoreProxy.proxy.addCraftingRecipe(new ItemStack(tankBlock), new Object[] { "ggg", "g g", "ggg", 'g', Block.glass, });
        CoreProxy.proxy.addCraftingRecipe(
                new ItemStack(refineryBlock),
                new Object[] { "   ", "RTR", "TGT", 'T', tankBlock, 'G', BuildCraftCore.diamondGearItem,
        ...
        if (!hopperDisabled)
        {
            CoreProxy.proxy.addCraftingRecipe(new ItemStack(hopperBlock),
                    new Object[] { "ICI", "IGI", " I ", 'I', Item.ingotIron, 'C', Block.chest, 'G',
